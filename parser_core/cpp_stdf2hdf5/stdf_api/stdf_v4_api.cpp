...
{
    if(impl->CMD_LINE.empty()) return null_ptr;
...
{
    if(impl->USR_DESC.empty()) return null_ptr;
    return impl->USR_DESC.c_str();
}

const char* StdfMRR::get_exec_discription() const
{
    if(impl->EXC_DESC.empty()) return null_ptr;
...
{
    if(impl->HBIN_NAM.empty()) return null_ptr;
...
{
    if(impl->SBIN_NAM.empty()) return null_ptr;
...
{
    if(impl->GRP_NAM.empty()) return null_ptr;
...
const char* StdfPLR::get_program_state_right(unsigned short index) const
{
    ...
    if(impl->PGM_CHAR[index].empty()) return null_ptr;
...
const char* StdfPLR::get_return_state_right(unsigned short index) const
{
    ...
    if(impl->RTN_CHAR[index].empty()) return null_ptr;
...
const char* StdfPLR::get_program_state_left(unsigned short index) const
{
    ...
    if(impl->PGM_CHAL[index].empty()) return null_ptr;
...
const char* StdfPLR::get_return_state_left(unsigned short index) const
{
    ...
    if(impl->RTN_CHAL[index].empty()) return null_ptr;
...
{
    if(impl->WAFER_ID.empty()) return null_ptr;
...
{
    if(impl->PART_ID.empty()) return null_ptr;
    return impl->PART_ID.c_str();
}

const char* StdfPRR::get_part_discription() const
{
    if(impl->PART_TXT.empty()) return null_ptr;
...
{
    if(impl->TEST_TXT.empty()) return null_ptr;
    return impl->TEST_TXT.c_str();
}

const char* StdfPTR::get_alarm_id() const
{
    if(impl->ALARM_ID.empty()) return null_ptr;
...
{
    if(impl->UNITS_IN.empty()) return null_ptr;
...
{
    if(impl->PROG_TXT.empty()) return null_ptr;
    return impl->PROG_TXT.c_str();
}

const char* StdfFTR::get_result_text() const
{
    if(impl->RSLT_TXT.empty()) return null_ptr;
...
{
    if(impl->TEXT_DAT.empty()) return null_ptr;
